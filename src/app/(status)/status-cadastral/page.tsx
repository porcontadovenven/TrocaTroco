...
export default async function PaginaStatusCadastral() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-stone-50 px-6 py-16">
      <div className="w-full max-w-lg rounded-3xl border border-stone-900/10 bg-white p-8 shadow-sm">
        ...
        {status === "reprovada" && (
          <div className="flex flex-col gap-4">
            ...
            <a
              href="/cadastro"
              className="inline-block rounded-xl bg-stone-900 px-5 py-2.5 text-center text-sm font-semibold text-white hover:bg-stone-700"
            >
              Corrigir e reenviar
            </a>
          </div>
...
function Badge({ cor, texto }: { cor: "amarelo" | "verde" | "vermelho"; texto: string }) {
  const classes = {
    amarelo: "bg-amber-50 border-amber-200 text-amber-800",
