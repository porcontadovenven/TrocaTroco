...
const STATUS_COR: Record<string, string> = {
  ...
  encerrado: "bg-stone-100 border-stone-200 text-stone-500",
};
    ...
    <main className="min-h-screen bg-stone-50 px-6 py-10">
      <div className="mx-auto max-w-4xl">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-stone-900">Tickets / denúncias</h1>
        ...
        {tickets.length === 0 && (
          <div className="rounded-3xl border border-stone-200 bg-white p-10 text-center text-sm text-stone-400">
          ...
          ({ label, items }) =>
            items.length > 0 && (
              <section key={label} className="mb-8">
                <h2 className="mb-3 text-sm font-semibold text-stone-700">{label}</h2>
                  ...
                  {items.map((ticket) => (
                    ...
                    >
                      <div className="mb-3 flex flex-wrap items-center gap-2">
                        ...
                        <span className="rounded-full border border-stone-200 bg-stone-50 px-2.5 py-0.5 text-xs text-stone-500">
                      ...
                      {ticket.descricao && (
                        <p className="mb-3 text-sm text-stone-600 line-clamp-3">
                          {ticket.descricao}
                        </p>
                      )}

                      {ticket.resumo_resolucao && (
                        <div className="mb-3 rounded-xl border border-stone-100 bg-stone-50 px-4 py-2.5">
                          <p className="text-xs font-medium text-stone-500">Resolução</p>
