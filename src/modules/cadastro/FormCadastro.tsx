...
export function FormCadastro() {
  ...
  function validarEtapa1(): string | null {
    if (!campos.cnpj.replace(/\D/g, "")) return "CNPJ é obrigatório.";
    if (!campos.razao_social) return "Razão social é obrigatória.";
    if (!campos.email_empresa) return "E-mail da empresa é obrigatório.";
    if (!campos.telefone_empresa) return "Telefone da empresa é obrigatório.";
    if (!campos.endereco_linha) return "Endereço é obrigatório.";
    if (!campos.cidade) return "Cidade é obrigatória.";
  ...
  function validarEtapa2(): string | null {
    ...
    if (!campos.cpf.replace(/\D/g, "")) return "CPF é obrigatório.";
    if (!campos.telefone_responsavel) return "Telefone é obrigatório.";
      ...
      <form action={action} className="flex flex-col gap-5">
        ...
        {etapa === 1 && (
          <div className="flex flex-col gap-4">
            <Campo label="CNPJ" name="cnpj" value={campos.cnpj} onChange={atualizar} placeholder="00.000.000/0001-00" />
            ...
            <Campo label="Telefone" name="telefone_empresa" value={campos.telefone_empresa} onChange={atualizar} placeholder="(11) 99999-9999" />
            <Campo label="Endereço (logradouro)" name="endereco_linha" value={campos.endereco_linha} onChange={atualizar} />
            <div className="grid grid-cols-2 gap-3">
              <Campo label="Número" name="endereco_numero" value={campos.endereco_numero} onChange={atualizar} />
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Campo label="CEP" name="cep" value={campos.cep} onChange={atualizar} placeholder="00000-000" />
            </div>
            <div className="grid grid-cols-2 gap-3">
              <Campo label="Cidade" name="cidade" value={campos.cidade} onChange={atualizar} />
              <Campo label="Estado (UF)" name="estado" value={campos.estado} onChange={atualizar} placeholder="SP" />
            </div>
          </div>
        )}
        ...
        {etapa === 2 && (
          <div className="flex flex-col gap-4">
            ...
            <Campo label="CPF" name="cpf" value={campos.cpf} onChange={atualizar} placeholder="000.000.000-00" />
            <Campo label="Telefone" name="telefone_responsavel" value={campos.telefone_responsavel} onChange={atualizar} placeholder="(11) 99999-9999" />
